...
@section('content')
    ...
    <div class="section no-pad-bot" id="index-banner">
        <div class="container">
            <br><br><br><br><br>
            <h1 class="header center orange-text banner-text">Contact Raiochplay</h1>
            <div class="row center">
                <h5 class="header col s12 light subtext">Ne puteti contacta folosin formularul de mai jos</h5>
            </div>
            <div class="row center">
